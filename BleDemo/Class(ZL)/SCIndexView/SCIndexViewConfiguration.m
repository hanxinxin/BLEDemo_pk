...
//            indicatorBackgroundColor = SCGetColor(200, 200, 200, 1);
            indicatorBackgroundColor = [UIColor clearColor];
            indicatorTextColor = [UIColor clearColor];
...
//                              indexItemTextColor:[UIColor darkGrayColor]
            indexItemTextColor:[UIColor colorWithRed:20/255.0 green:146/255.0 blue:230/255.0 alpha:1.0]
//                indexItemSelectedBackgroundColor:SCGetColor(40, 170, 40, 1)
            indexItemSelectedBackgroundColor:[UIColor colorWithRed:20/255.0 green:146/255.0 blue:230/255.0 alpha:1.0]

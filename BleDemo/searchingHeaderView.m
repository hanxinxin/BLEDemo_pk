...
@interface searchingHeaderView()

@property (nonatomic, strong) UILabel *titleLabel;

@end

@implementation searchingHeaderView
...
- (UILabel *)titleLabel {
    if (!_titleLabel) {
        ...
        _titleLabel.textColor =[UIColor colorWithRed:20/255.0 green:146/255.0 blue:230/255.0 alpha:1.0];
